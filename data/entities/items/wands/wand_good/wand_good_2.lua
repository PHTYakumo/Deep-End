...
gun.deck_capacity = 18
gun.actions_per_round = 1
gun.reload_time = -2345
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {6,18}
gun.spread_degrees = 0
gun.speed_multiplier = 1.33
gun.mana_charge_speed = 233
gun.mana_max = {999,1234}
gun.actions = {"NUKE","BOMB_HOLY"}
...
AddGunActionPermanent( entity_id, "ORBIT_NUKES" )
...
AddGunAction( entity_id, "CRUMBLING_EARTH" )
