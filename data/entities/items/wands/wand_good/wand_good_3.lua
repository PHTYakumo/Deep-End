...
gun.deck_capacity = 27
gun.actions_per_round = 27
gun.reload_time = {24,36}
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {3,9}
gun.spread_degrees = {0,6}
gun.speed_multiplier = 1.5
gun.mana_charge_speed = {345,456}
gun.mana_max = {1234,1600}
gun.actions = {"GRENADE_TIER_3","ROCKET_TIER_3","DISC_BULLET_BIG","LANCE"}
