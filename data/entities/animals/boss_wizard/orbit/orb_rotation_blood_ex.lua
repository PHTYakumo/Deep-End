...
if ( comp ~= nil ) then
	...
	local dir = inc * id + GameGetFrameNum() * 0.008 + math.pi / count
	
	local nx = x + math.cos( dir ) * ( 50 + 16 * math.sin( 3 * dir ) ) -- circle + rose curve
	local ny = y - 20 + math.sin( dir ) * ( 50 + 16 * math.sin( 3 * dir ) )
