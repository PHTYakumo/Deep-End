...
CHANCE_OF_MODIFIER_COALMINE = CHANCE_OF_MODIFIER_PER_BIOME * 0.6 + 0.2
CHANCE_OF_MODIFIER_EXCAVATIONSITE = CHANCE_OF_MODIFIER_PER_BIOME * 0.5 + 0.4
CHANCE_OF_MOIST_FUNGICAVE = 0.8
CHANCE_OF_MOIST_LAKE = 0.9
...
biome_modifiers =
{
	...
	-- root growers, swamp & soil materials
	{
		...
		probability=0.6,
		does_not_apply_to_biome={"rainforest","rainforest_open","mountain_hall"},
	...
	-- fungus props
	{
		...
		probability=0.5,
		does_not_apply_to_biome={"mountain_hall","fungicave"},
		action = function( biome_name, biome_filename )
			BiomeObjectSetValue( biome_filename, "modifiers", "dust_amount", 0.6 )
			BiomeSetValue( biome_filename, "color_grading_r", 0.90 )
