...
RegisterSpawnFunction( 0xff9f2a00, "spawn_statue_01" )
RegisterSpawnFunction( 0xff7345DF, "spawn_statue_02" )
...
function spawn_fish(x, y)
	...
	local f = math.ceil( GameGetOrbCountAllTime()^0.5 )
	for i=1,f do EntityLoad( "data/entities/animals/fish_large.xml", x, y ) end
end