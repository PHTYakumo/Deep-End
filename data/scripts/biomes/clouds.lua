...
g_small_enemies =
{
	...
	},
	{
		...
		min_count	= 1,
		max_count	= 1,    
		entities 	= { "data/entities/animals/wizard_swapper.xml", "data/entities/animals/wizard_tele.xml" },
	},
	{
		prob   		= 0.5,
		min_count	= 1,
	...
	},
	{
		...
		min_count	= 1,
		max_count	= 1,    
		entities 	= { "data/entities/animals/necrobot.xml", "data/entities/animals/spearbot.xml" },
	},
	{
		prob   		= 0.12,
		min_count	= 1,
