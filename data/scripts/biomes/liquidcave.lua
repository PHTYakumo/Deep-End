...
g_items =
{
	...
	},
	{
		...
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/items/wand_level_01_p.xml"
	},
	{
		prob   		= 0.5,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/items/wand_level_02_p.xml"
	},
	{
		prob   		= 0.4,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/items/wand_level_03_p.xml"
	},
	{
		prob   		= 0.3,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/items/wand_unshuffle_01_p.xml"
	},
	{
		prob   		= 0.2,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/items/wand_unshuffle_02_p.xml"
	},
	{
		prob   		= 0.1,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/items/wand_unshuffle_03_p.xml"
	},
}
...
g_pixel_scene_01 =
{
	total_prob = 0,
	{
		...
		background_file	= "",
		is_unique		= 0,
		color_material = { ["fff0bbee"] = { "magic_liquid_faster_levitation_and_movement", "midas_precursor", "deep_end_laser_eye_potion", "deep_end_gravity_potion", "sodium", "mammi", "cursed_liquid", "porridge" } }
	},
}
