...
g_big_enemies =
{
	...
	},
	{
		...
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/animals/boss_centipede/boss_centipede_minion.xml"
	},
	{
		prob   		= 0.8,
		min_count	= 1,
...
g_scorpions =
{
	total_prob = 0,
	{
		...
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/animals/statue.xml"
	},
		-- add skullflys after this step
	{
		prob   		= 0.3,
		min_count	= 1,
		max_count	= 1,    
		entity 	= "data/entities/animals/mimic_potion.xml"
	},
}
