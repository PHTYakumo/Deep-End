...
x,y = vec_mult(x, y, distance + Random(-2,3) )
x,y = vec_add(x, y, item_x + iris_distance*math.cos(GameGetFrameNum()/12), item_y + iris_distance*math.sin(GameGetFrameNum()/12) )
