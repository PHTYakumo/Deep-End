...
function collision_trigger()
	...
	local bomb_lists = { "mega", "joke", "mini" }
	local bomb_type = math.ceil( Random( 1, 15 )^0.4 - 0.01 )

	local bomb_id = EntityLoad("data/entities/projectiles/bomb_holy_" .. bomb_lists[bomb_type] .. ".xml", pos_x-144, pos_y+44)
	PhysicsApplyTorque( bomb_id, Random( 1, 1000 ) )
