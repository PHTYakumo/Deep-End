...
# Install the mod
- Download the latest release, or other version if you like.
- Unzip and rename the folder to ``deep_end``
- Put the folder into your noita mod folder, such as ``C:\Program Files (x86)\Steam\steamapps\common\Noita\mods\``
